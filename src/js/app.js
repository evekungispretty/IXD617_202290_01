...
import { checkHouseAddForm, checkHouseDeleteForm, checkHouseEditForm, checkPasswordEditForm, checkSignupForm, checkUserEditForm} from "./form.js";
...
//   $(".houselist").html($('#ddlList option').sort(function(x, y) {
